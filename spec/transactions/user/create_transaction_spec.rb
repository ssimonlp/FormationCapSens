...
RSpec.describe User::CreateTransaction do
  describe 'database' do
    context 'with valid params'do
      ...
      let(:params) {  user_params.merge(profile_attributes: profile_params) }#c'est dégueulasse je changerai quand je modifierai ma transaction dans la prochaine carte
